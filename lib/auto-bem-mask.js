...
function initializeMaskModule(mask) {
...
exports.initializeMaskModule = initializeMaskModule;
;
				
					function isObject(x) {
						return x != null && typeof x === 'object' && x.constructor === Object;
					}
					if (isObject(_src_Module) && isObject(module.exports)) {
						Object.assign(_src_Module, module.exports);
						return;
					}
...
Object.defineProperty(exports, "__esModule", { value: true });
var AutoBem = _node_modules_auto_bem_lib_index;
function create(decorator, node, ctr) {
...
var StyleNodeHandler = /** @class */ (function () {
    function StyleNodeHandler(decoratorNode, styleNode) {
    ...
    StyleNodeHandler.prototype.beforeRender = function (node, model, ctx, el, ctr) {
...
;
					...
					if (isObject(_src_DecoWithStyle) && isObject(module.exports)) {
						Object.assign(_src_DecoWithStyle, module.exports);
						return;
					}
...
function create(decorator, node, ctr) {
    ...
    var module = result[0], importNode = result[1];
    return new BemModuleHandler(decorator, importNode, module);
}
exports.create = create;
var BemModuleHandler = /** @class */ (function () {
    function BemModuleHandler(decorator, importNode, module) {
        this.decorator = decorator;
        this.importNode = importNode;
        this.module = module;
    }
    BemModuleHandler.prototype.beforeRender = function (node, model, ctx, el, ctr) {
        var _a = this, module = _a.module, importNode = _a.importNode;
        module.bemCss.transformAst(node);
        if (globals_1.mask.is.NODE) {
...
(function () {
    ...
    function tryGetFromCompos(ctr, name) {
        var module = null, importNode = null;
        for (var cursor = ctr; cursor != null; cursor = cursor.parent) {
            ...
            for (var i = 0; i < imports.length; i++) {
                ...
                if (module != null) {
                    globals_1.mask.log.errorWithNode('Ambiguous BEM import found', import_);
                    return null;
                }
    ...
    function tryGetFromAst(node, name) {
        ...
        if (importNode != null) {
            var root = void 0;
            for (var cursor = importNode; cursor != null; cursor = cursor.parent) {
                if (cursor.parent == null) {
                    root = cursor;
                }
            }
            if (root && root.filename) {
                module = globals_1.mask.Module.createModule(importNode, root);
            }
        }
        if (module != null) {
            getBemModule_Return[0] = module;
...
;
					...
					if (isObject(_src_DecoWithImport) && isObject(module.exports)) {
						Object.assign(_src_DecoWithImport, module.exports);
						return;
					}
				...
				(function () {
					...
					"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var DecoWithStyle_1 = _src_DecoWithStyle;
var DecoWithImport_1 = _src_DecoWithImport;
function initializeMaskDecorator(mask) {
    mask.defineDecorator('bem', {
        ...
        beforeRender: function (node, model, ctx, el, ctr) {
            var handler = DecoWithStyle_1.create(this, node, ctr) || DecoWithImport_1.create(this, node, ctr);
            if (handler) {
...
exports.initializeMaskDecorator = initializeMaskDecorator;
;
				
					function isObject(x) {
						return x != null && typeof x === 'object' && x.constructor === Object;
					}
					if (isObject(_src_Decorator) && isObject(module.exports)) {
						Object.assign(_src_Decorator, module.exports);
						return;
					}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Module_1 = _src_Module;
var Decorator_1 = _src_Decorator;
var globals_1 = _src_globals;
Module_1.initializeMaskModule(globals_1.mask);
Decorator_1.initializeMaskDecorator(globals_1.mask);
